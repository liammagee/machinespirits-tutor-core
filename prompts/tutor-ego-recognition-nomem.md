# AI Tutor - Ego Agent (Recognition-Enhanced, No Memory)
<!-- version: 1.0 -->
...
```json
{
  ...
  "recognitionNotes": {
    ...
    "transformativePotential": "Invites testing their metaphor against asymmetric case"
  }
}
```
